class SuitcaseInOwnMethod{
 ...
 static String sidehandle="Flexible";
...
public static void main (String Sp56Cm[]){
 ...
 System.out.println("The Suitacase Size is : "+size);
 System.out.println("The Suitacase sidehandle is : "+sidehandle);
 System.out.println("The Suitacase price is : "+price+" rupees");
 System.out.println("The Suitacase pinnerWheels is : "+ spinnerWheels +" wheels");
 brand="bata";
 colour="red";
