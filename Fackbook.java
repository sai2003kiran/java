class Fackbook{
 public static String userProfile(String fullName, String dob,String email,String conformEmail,String userName,String password, String conformPassword){
 String details = null;
 boolean validation = verification(fullName,dob,email,conformEmail,userName,password,conformPassword);
 if(validation==true){
 ...
 public static boolean verification(String fristName,String dob,String email,String conformEmail,String userName,String password,String conformPassword){
